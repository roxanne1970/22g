...
! function(t, e) {
    ...
    a.jQueryDetection(), n.default.fn.emulateTransitionEnd = function(t) {
        var e = this,
            i = !1;
        ...
        u = function() {
            ...
            return e.close = function(t) {
                ...
                var e = a.getSelectorFromElement(t),
                    i = !1;
                return e && (i = document.querySelector(e)), i || (i = n.default(t).closest(".alert")[0]), i
            }, e._triggerCloseEvent = function(t) {
                var e = n.default.Event("close.bs.alert");
                return n.default(t).trigger(e), e
            }, e._removeElement = function(t) {
                var e = this;
                if (n.default(t).removeClass("show"), n.default(t).hasClass("fade")) {
            ...
            return e.toggle = function() {
                ...
                if (i) {
                    ...
                    if (o) {
                        ...
                        t && ("checkbox" !== o.type && "radio" !== o.type || (o.checked = !this._element.classList.contains("active")), this.shouldAvoidTriggerChange || n.default(o).trigger("change")), o.focus(), e = !1
                    }
                }
                this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains("active")), t && n.default(this._element).toggleClass("active"))
            }, e.dispose = function() {
                ...
                return this.each((function() {
                    var o = n.default(this),
                        r = o.data("bs.button");
                    r || (r = new t(this), o.data("bs.button", r)), r.shouldAvoidTriggerChange = i, "toggle" === e && r[e]()
                }))
            }, o(t, null, [{
                key: "VERSION",
                get: function() {
    ...
    n.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', (function(t) {
        var e = t.target,
            i = e;
        if (n.default(e).hasClass("btn") || (e = n.default(e).closest(".btn")[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
        else {
        ...
        return n.default.fn.button = f, d._jQueryInterface
    };
    var c = "carousel",
        h = n.default.fn[c],
        p = {
        ...
        v = function() {
            ...
            return e.next = function() {
                ...
                return t = r({}, p, t), a.typeCheckConfig(c, t, m), t
                ...
                if ("next" === t ? (i = "carousel-item-left", o = "carousel-item-next", r = "left") : (i = "carousel-item-right", o = "carousel-item-prev", r = "right"), f && n.default(f).hasClass("active")) this._isSliding = !1;
                    ...
                    if (n.default(this._element).hasClass("slide")) {
                        n.default(f).addClass(o), a.reflow(f), n.default(l).addClass(i), n.default(f).addClass(i);
                        var p = a.getTransitionDurationFromElement(l);
                        n.default(l).one(a.TRANSITION_END, (function() {
                            n.default(f).removeClass(i + " " + o).addClass("active"), n.default(l).removeClass("active " + o + " " + i), s._isSliding = !1, setTimeout((function() {
                                return n.default(s._element).trigger(h)
                            }), 0)
                        })).emulateTransitionEnd(p)
                    } else n.default(l).removeClass("active"), n.default(f).addClass("active"), this._isSliding = !1, n.default(this._element).trigger(h);
                    c && this.cycle()
                }
            }, t._jQueryInterface = function(e) {
                return this.each((function() {
                    ...
                    if (i || (i = new t(this, o), n.default(this).data("bs.carousel", i)), "number" == typeof e) i.to(e);
                ...
                if (i) {
                    ...
                    if (o && n.default(o).hasClass("carousel")) {
                        ...
                        l && (s.interval = !1), t._jQueryInterface.call(n.default(o), s), l && n.default(o).data("bs.carousel").to(l), e.preventDefault()
                    }
                }
            }, o(t, null, [{
                key: "VERSION",
    ...
    })), n.default.fn[c] = v._jQueryInterface, n.default.fn[c].Constructor = v, n.default.fn[c].noConflict = function() {
        return n.default.fn[c] = h, v._jQueryInterface
    };
    var _ = "collapse",
        b = n.default.fn[_],
        y = {
        ...
        E = function() {
            ...
            return e.toggle = function() {
                ...
                if (!(this._isTransitioning || n.default(this._element).hasClass("show") || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function(t) {
                    ...
                    }))).length && (e = null), e && (i = n.default(e).not(this._selector).data("bs.collapse")) && i._isTransitioning))) {
                    ...
                    if (n.default(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        n.default(this._element).one(a.TRANSITION_END, (function() {
                            n.default(o._element).removeClass("collapsing").addClass("collapse show"), o._element.style[s] = "", o.setTransitioning(!1), n.default(o._element).trigger("shown.bs.collapse")
                ...
                if (!this._isTransitioning && n.default(this._element).hasClass("show")) {
                    ...
                    if (n.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", a.reflow(this._element), n.default(this._element).addClass("collapsing").removeClass("collapse show");
                ...
                return (t = r({}, y, t)).toggle = Boolean(t.toggle), a.typeCheckConfig(_, t, w), t
                ...
                return this.each((function() {
                    ...
                    if (!o && a.toggle && "string" == typeof e && /show|hide/.test(e) && (a.toggle = !1), o || (o = new t(this, a), i.data("bs.collapse", o)), "string" == typeof e) {
    ...
    })), n.default.fn[_] = E._jQueryInterface, n.default.fn[_].Constructor = E, n.default.fn[_].noConflict = function() {
        return n.default.fn[_] = b, E._jQueryInterface
    };
    var T = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        C = function() {
            for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
                if (T && navigator.userAgent.indexOf(t[e]) >= 0) return 1;
            return 0
        }(),
    ...
    function L(t) {
        ...
        for (var e = j(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;) n = (t = t.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
    ...
    function F(t, e) {
        ...
        if (t !== l && e !== l || i.contains(o)) return "BODY" === (s = (a = l).nodeName) || "HTML" !== s && L(a.firstElementChild) !== a ? L(l) : l;
        var u = P(t);
    ...
    function X(t, e) {
        ...
        return (i && !n ? e.contains(s) : e === s && "BODY" !== s.nodeName) && (d = H(d, e)), d
    }
    ...
    function $(t) {
        if (!t || !t.parentElement || j()) return document.documentElement;
    ...
    function J(t, e, n, i) {
        ...
        if ("viewport" === i) r = K(a, o);
            ...
            var l = X(s, a, o);
            if ("HTML" !== s.nodeName || G(a)) r = l;
            else {
                var u = B(t.ownerDocument),
                    f = u.height,
                    d = u.width;
    ...
    function ot(t, e, n) {
        ...
        var i = nt(t),
            ...
            l = r ? "height" : "width",
            u = r ? "width" : "height";
        return o[a] = e[a] + e[l] / 2 - i[l] / 2, o[s] = n === s ? e[s] - i[u] : e[it(s)], o
    }
    ...
    function at(t, e, n) {
        return (void 0 === n ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && D(n) && (e.offsets.popper = Y(e.offsets.popper), e.offsets.reference = Y(e.offsets.reference), e = n(e, t))
        })), e
    }
    ...
    function st() {
        if (!this.state.isDestroyed) {
            ...
            t.offsets.reference = et(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = tt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = ot(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = at(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
        }
    }
        ...
        this.state.eventsEnabled || (this.state = function(t, e, n, i) {
            ...
            return function t(e, n, i, o) {
                ...
                a.addEventListener(n, i, {
                    passive: !0
                }), r || t(A(a.parentNode), n, i, o), o.push(a)
    ...
    function mt(t, e) {
        Object.keys(e).forEach((function(n) {
            var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && pt(e[n]) && (i = "px"), t.style[n] = e[n] + i
        }))
    }
    var gt = T && /Firefox/i.test(navigator.userAgent);
    ...
    var wt = {
            ...
            modifiers: {
                ...
                offset: {
                    ...
                    fn: function(t, e) {
                        var n, i = e.offset,
                            ...
                            s = r.reference,
                            l = o.split("-")[0];
                        return n = pt(+i) ? [+i, 0] : function(t, e, n, i) {
                            var o = [0, 0],
                                r = -1 !== ["right", "left"].indexOf(i),
                                a = t.split(/(\+|\-)/).map((function(t) {
                                    return t.trim()
                                })),
                                s = a.indexOf(rt(a, (function(t) {
                                    return -1 !== t.search(/,|\s/)
                                })));
                    ...
                    fn: function(t, e) {
                        ...
                        var u = e.priority,
                            ...
                            d = {
                                primary: function(t) {
                                    var n = f[t];
                                    return f[t] < l[t] && !e.escapeWithReference && (n = Math.max(f[t], l[t])), U({}, t, n)
                                },
                                secondary: function(t) {
                                    var n = "right" === t ? "left" : "top",
                                        i = f[n];
                                    return f[t] > l[t] && !e.escapeWithReference && (i = Math.min(f[n], l[t] - ("right" === t ? f.width : f.height))), U({}, n, i)
                                }
                            };
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        var o = t.placement.split("-")[0],
                            ...
                            h = l ? "bottom" : "right",
                            p = nt(i)[u];
                        s[h] - p < a[d] && (t.offsets.popper[d] -= a[d] - (s[h] - p)), s[d] + p > a[h] && (t.offsets.popper[d] += s[d] + p - a[h]), t.offsets.popper = Y(t.offsets.popper);
                        var m = s[d] + s[u] / 2 - p / 2,
                            g = N(t.instance.popper),
                            v = parseFloat(g["margin" + f]),
                            _ = parseFloat(g["border" + f + "Width"]),
                            b = m - t.offsets.popper[d] - v - _;
                        return b = Math.max(Math.min(a[u] - p, b), 0), t.arrowElement = i, t.offsets.arrow = (U(n = {}, d, Math.round(b)), U(n, c, ""), n), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(t, e) {
                        ...
                        return a.forEach((function(s, l) {
                            ...
                            }(r)), t.placement = i + (r ? "-" + r : ""), t.offsets.popper = V({}, t.offsets.popper, ot(t.instance.popper, t.offsets.reference, t.placement)), t = at(t.instance.modifiers, t, "flip"))
                        })), t
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function(t) {
                        ...
                        return o[a ? "left" : "top"] = r[n] - (s ? o[a ? "width" : "height"] : 0), t.placement = it(e), t.offsets.popper = Y(o), t
                    }
                },
                hide: {
                    order: 800,
                    enabled: !0,
                    fn: function(t) {
                        if (!vt(t.instance.modifiers, "hide", "preventOverflow")) return t;
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        if (s = "bottom" === h ? "HTML" === u.nodeName ? -u.clientHeight + c.bottom : -f.height + c.bottom : c.top, a = "right" === p ? "HTML" === u.nodeName ? -u.clientWidth + c.right : -f.width + c.right : c.left, l && m) d[m] = "translate3d(" + a + "px, " + s + "px, 0)", d[h] = 0, d[p] = 0, d.willChange = "transform";
                            ...
                            var g = "bottom" === h ? -1 : 1,
                                v = "right" === p ? -1 : 1;
                            d[h] = s * g, d[p] = a * v, d.willChange = h + ", " + p
                        }
                        var _ = {
                            "x-placement": t.placement
                        };
                        return t.attributes = V({}, _, t.attributes), t.styles = V({}, d, t.styles), t.arrowStyles = V({}, t.offsets.arrow, t.arrowStyles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    onLoad: function(t, e, n, i, o) {
                        var r = et(o, e, t, n.positionFixed),
                            a = tt(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
                        return e.setAttribute("x-placement", a), mt(e, {
        ...
        Et = function() {
            function t(e, n) {
                ...
                }, this.update = S(this.update.bind(this)), this.options = V({}, t.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = n && n.jquery ? n[0] : n, this.options.modifiers = {}, Object.keys(V({}, t.Defaults.modifiers, o.modifiers)).forEach((function(e) {
    ...
    Et.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Et.placements = _t, Et.Defaults = wt;
    var Tt = "dropdown",
        Ct = n.default.fn[Tt],
        ...
        kt = function() {
            ...
            return e.toggle = function() {
                ...
                if (void 0 === e && (e = !1), !(this._element.disabled || n.default(this._element).hasClass("disabled") || n.default(this._menu).hasClass("show"))) {
                    var i = {
                            relatedTarget: this._element
                        },
                        o = n.default.Event("show.bs.dropdown", i),
                        r = t._getParentFromElement(this._element);
                    if (n.default(r).trigger(o), !o.isDefaultPrevented()) {
                        if (!this._inNavbar && e) {
                            if (void 0 === Et) throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                            var s = this._element;
                            "parent" === this._config.reference ? s = r : a.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && n.default(r).addClass("position-static"), this._popper = new Et(s, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === n.default(r).closest(".navbar-nav").length && n.default(document.body).children().on("mouseover", null, n.default.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), n.default(this._menu).toggleClass("show"), n.default(r).toggleClass("show").trigger(n.default.Event("shown.bs.dropdown", i))
                    }
                }
            }, e.hide = function() {
                if (!this._element.disabled && !n.default(this._element).hasClass("disabled") && n.default(this._menu).hasClass("show")) {
                    ...
                    n.default(o).trigger(i), i.isDefaultPrevented() || (this._popper && this._popper.destroy(), n.default(this._menu).toggleClass("show"), n.default(o).toggleClass("show").trigger(n.default.Event("hidden.bs.dropdown", e)))
                }
            }, e.dispose = function() {
                ...
                return t = r({}, this.constructor.Default, n.default(this._element).data(), t), a.typeCheckConfig(Tt, t, this.constructor.DefaultType), t
                ...
                var t = n.default(this._element.parentNode),
                    e = "bottom-start";
                return t.hasClass("dropup") ? e = n.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : n.default(this._menu).hasClass("dropdown-menu-right") && (e = "bottom-end"), e
                ...
                return this.each((function() {
                    ...
                    if (i || (i = new t(this, "object" == typeof e ? e : null), n.default(this).data("bs.dropdown", i)), "string" == typeof e) {
                    ...
                    for (var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), o = 0, r = i.length; o < r; o++) {
                        ...
                        if (e && "click" === e.type && (l.clickEvent = e), s) {
                            ...
                            if (n.default(a).hasClass("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && n.default.contains(a, e.target))) {
                                ...
                                n.default(a).trigger(f), f.isDefaultPrevented() || ("ontouchstart" in document.documentElement && n.default(document.body).children().off("mouseover", null, n.default.noop), i[o].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), n.default(u).removeClass("show"), n.default(a).removeClass("show").trigger(n.default.Event("hidden.bs.dropdown", l)))
                            }
                        }
                    }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || n.default(e.target).closest(".dropdown-menu").length) : !St.test(e.which)) && !this.disabled && !n.default(this).hasClass("disabled")) {
                    var i = t._getParentFromElement(this),
                        o = n.default(i).hasClass("show");
                    if (o || 27 !== e.which) {
                        if (e.preventDefault(), e.stopPropagation(), !o || 27 === e.which || 32 === e.which) return 27 === e.which && n.default(i.querySelector('[data-toggle="dropdown"]')).trigger("focus"), void n.default(this).trigger("click");
    ...
    n.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', kt._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", kt._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", kt._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function(t) {
        t.preventDefault(), t.stopPropagation(), kt._jQueryInterface.call(n.default(this), "toggle")
    })).on("click.bs.dropdown.data-api", ".dropdown form", (function(t) {
        t.stopPropagation()
    })), n.default.fn[Tt] = kt._jQueryInterface, n.default.fn[Tt].Constructor = kt, n.default.fn[Tt].noConflict = function() {
        return n.default.fn[Tt] = Ct, kt._jQueryInterface
    };
    var At = n.default.fn.modal,
        It = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
        ...
        xt = function() {
            ...
            return e.toggle = function(t) {
                ...
                return t = r({}, It, t), a.typeCheckConfig("modal", t, Ot), t
                ...
                if (n.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    n.default(this._element).off(a.TRANSITION_END), n.default(this._element).one(a.TRANSITION_END, (function() {
                        t._element.classList.remove("modal-static"), i || n.default(t._element).one(a.TRANSITION_END, (function() {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), n.default(this._dialog).hasClass("modal-dialog-scrollable") && o ? o.scrollTop = 0 : this._element.scrollTop = 0, i && a.reflow(this._element), n.default(this._element).addClass("show"), this._config.focus && this._enforceFocus();
                var r = n.default.Event("shown.bs.modal", {
                        relatedTarget: t
                    }),
                    s = function() {
                        e._config.focus && e._element.focus(), e._isTransitioning = !1, n.default(e._element).trigger(r)
                    };
                if (i) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), n.default(this._backdrop).appendTo(document.body), n.default(this._element).on("click.dismiss.bs.modal", (function(t) {
                        ...
                        })), i && a.reflow(this._backdrop), n.default(this._backdrop).addClass("show"), !t) return;
                    if (!i) return void t();
                ...
                return this.each((function() {
                    var o = n.default(this).data("bs.modal"),
                        a = r({}, It, n.default(this).data(), "object" == typeof e && e ? e : {});
                    if (o || (o = new t(this, a), n.default(this).data("bs.modal", o)), "string" == typeof e) {
                        if (void 0 === o[e]) throw new TypeError('No method named "' + e + '"');
                        o[e](i)
    ...
    n.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function(t) {
        ...
        xt._jQueryInterface.call(n.default(e), s, this)
    })), n.default.fn.modal = xt._jQueryInterface, n.default.fn.modal.Constructor = xt, n.default.fn.modal.noConflict = function() {
        return n.default.fn.modal = At, xt._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(e), r = [].slice.call(i.body.querySelectorAll("*")), a = function(t, n) {
                ...
                s.forEach((function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n)) return -1 === jt.indexOf(n) || Boolean(t.nodeValue.match(Lt) || t.nodeValue.match(Pt));
    ...
    var Rt = "tooltip",
        ...
        Vt = function() {
            function t(t, e) {
                if (void 0 === Et) throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        i || (i = new this.constructor(t.currentTarget, this._getDelegateConfig()), n.default(t.currentTarget).data(e, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                ...
                var e = this,
                    ...
                    r = function() {
                        "show" !== e._hoverState && i.parentNode && i.parentNode.removeChild(i), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), n.default(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t()
                    };
                if (n.default(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (n.default(i).removeClass("show"), "ontouchstart" in document.documentElement && n.default(document.body).children().off("mouseover", null, n.default.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, n.default(this.tip).hasClass("fade")) {
                ...
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Ft(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? n.default(e).parent().is(t) || t.empty().append(e) : t.text(n.default(e).text())
            }, e.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach((function(e) {
                    if ("click" === e) n.default(t.element).on(t.constructor.Event.CLICK, t.config.selector, (function(e) {
                        return t.toggle(e)
                    }));
                    else if ("manual" !== e) {
                ...
                return Object.keys(e).forEach((function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), a.typeCheckConfig(Rt, t, this.constructor.DefaultType), t.sanitize && (t.template = Ft(t.template, t.whiteList, t.sanitizeFn)), t
                ...
                return this.each((function() {
                    var i = n.default(this),
                        o = i.data("bs.tooltip"),
                        r = "object" == typeof e && e;
                    if ((o || !/dispose|hide/.test(e)) && (o || (o = new t(this, r), i.data("bs.tooltip", o)), "string" == typeof e)) {
                        if (void 0 === o[e]) throw new TypeError('No method named "' + e + '"');
                        o[e]()
                    }
                }))
    ...
    n.default.fn[Rt] = Vt._jQueryInterface, n.default.fn[Rt].Constructor = Vt, n.default.fn[Rt].noConflict = function() {
        return n.default.fn[Rt] = Ht, Vt._jQueryInterface
    };
    var Yt = "popover",
        zt = n.default.fn[Yt],
        ...
        Jt = function(t) {
            ...
            return a.isWithContent = function() {
                ...
                return this.each((function() {
                    ...
                    if ((e || !/dispose|hide/.test(t)) && (e || (e = new r(this, i), n.default(this).data("bs.popover", e)), "string" == typeof t)) {
    ...
    n.default.fn[Yt] = Jt._jQueryInterface, n.default.fn[Yt].Constructor = Jt, n.default.fn[Yt].noConflict = function() {
        return n.default.fn[Yt] = zt, Jt._jQueryInterface
    };
    var Zt = "scrollspy",
        te = n.default.fn[Zt],
        ee = {
        ...
        ie = function() {
            function t(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " .nav-link," + this._config.target + " .list-group-item," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, n.default(this._scrollElement).on("scroll.bs.scrollspy", (function(t) {
                    return i._process(t)
            ...
            return e.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map((function(t) {
                    ...
                    if (r && (e = document.querySelector(r)), e) {
                        ...
                        if (s.width || s.height) return [n.default(e)[i]().top + o, r]
                    }
                    return null
                })).filter((function(t) {
                    return t
                ...
                if ("string" != typeof(t = r({}, ee, "object" == typeof t && t ? t : {})).target && a.isElement(t.target)) {
                    var e = n.default(t.target).attr("id");
                    e || (e = a.getUID(Zt), n.default(t.target).attr("id", e)), t.target = "#" + e
                }
                return a.typeCheckConfig(Zt, t, ne), t
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass("active"), i.addClass("active")) : (i.addClass("active"), i.parents(".nav, .list-group").prev(".nav-link, .list-group-item").addClass("active"), i.parents(".nav, .list-group").prev(".nav-item").children(".nav-link").addClass("active")), n.default(this._scrollElement).trigger("activate.bs.scrollspy", {
                    relatedTarget: t
                })
            }, e._clear = function() {
                ...
                return this.each((function() {
                    ...
                    if (i || (i = new t(this, "object" == typeof e && e), n.default(this).data("bs.scrollspy", i)), "string" == typeof e) {
                        if (void 0 === i[e]) throw new TypeError('No method named "' + e + '"');
                        i[e]()
                    }
                }))
    ...
    })), n.default.fn[Zt] = ie._jQueryInterface, n.default.fn[Zt].Constructor = ie, n.default.fn[Zt].noConflict = function() {
        return n.default.fn[Zt] = te, ie._jQueryInterface
    };
    var oe = n.default.fn.tab,
        re = function() {
            function t(t) {
                this._element = t
            }
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && n.default(this._element).hasClass("active") || n.default(this._element).hasClass("disabled"))) {
                    ...
                    if (i && n.default(i).trigger(l), n.default(this._element).trigger(u), !u.isDefaultPrevented() && !l.isDefaultPrevented()) {
                ...
                if (n.default(t).addClass("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), a.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && n.default(t.parentNode).hasClass("dropdown-menu")) {
    ...
    n.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        t.preventDefault(), re._jQueryInterface.call(n.default(this), "show")
    })), n.default.fn.tab = re._jQueryInterface, n.default.fn.tab.Constructor = re, n.default.fn.tab.noConflict = function() {
        return n.default.fn.tab = oe, re._jQueryInterface
    };
    var ae = n.default.fn.toast,
        se = {
            animation: "boolean",
            autohide: "boolean",
            delay: "number"
        ...
        ue = function() {
            ...
            return e.show = function() {
                ...
                if (n.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    var i = function() {
                        t._element.classList.remove("showing"), t._element.classList.add("show"), n.default(t._element).trigger("shown.bs.toast"), t._config.autohide && (t._timeout = setTimeout((function() {
                            t.hide()
                        }), t._config.delay))
                    };
                ...
                if (this._element.classList.contains("show")) {
                    ...
                    n.default(this._element).trigger(t), t.isDefaultPrevented() || this._close()
                }
            }, e.dispose = function() {
                ...
                return t = r({}, le, n.default(this._element).data(), "object" == typeof t && t ? t : {}), a.typeCheckConfig("toast", t, this.constructor.DefaultType), t
            }, e._setListeners = function() {
                var t = this;
                ...
                var t = this,
                    e = function() {
                        t._element.classList.add("hide"), n.default(t._element).trigger("hidden.bs.toast")
                    };
                ...
                return this.each((function() {
                    var i = n.default(this),
                        o = i.data("bs.toast");
                    if (o || (o = new t(this, "object" == typeof e && e), i.data("bs.toast", o)), "string" == typeof e) {
                        if (void 0 === o[e]) throw new TypeError('No method named "' + e + '"');
                        o[e](this)
                    }
                }))
    ...
    n.default.fn.toast = ue._jQueryInterface, n.default.fn.toast.Constructor = ue, n.default.fn.toast.noConflict = function() {
        return n.default.fn.toast = ae, ue._jQueryInterface
    }, t.Alert = u, t.Button = d, t.Carousel = v, t.Collapse = E, t.Dropdown = kt, t.Modal = xt, t.Popover = Jt, t.Scrollspy = ie, t.Tab = re, t.Toast = ue, t.Tooltip = Vt, t.Util = a, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));