window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, r) {
        for (var a in e) {
            var i = t[e[a]];
            if (i !== n) return !1 === r ? e[a] : o(i, "function") ? i.bind(r || t) : i
        }
        return !1
    }
    ...
    function s(e, t, n) {
        var r = e.charAt(0).toUpperCase() + e.slice(1),
            a = (e + " " + x.join(r + " ") + r).split(" ");
        return o(t, "string") || o(t, "undefined") ? i(a, t) : c(a = (e + " " + w.join(r + " ") + r).split(" "), t, n)
    }
    var u, l, d = {},
        f = t.documentElement,
        m = "modernizr",
        ...
        P = function(e, n, r, o) {
            ...
            if (parseInt(r, 10))
                for (; r--;)(c = t.createElement("div")).id = o ? o[r] : m + (r + 1), u.appendChild(c);
            return a = ["&#173;", '<style id="s', m, '">', e, "</style>"].join(""), u.id = m, (l ? u : d).innerHTML += a, d.appendChild(u), l || (d.style.background = "", d.style.overflow = "hidden", s = f.style.overflow, f.style.overflow = "hidden", f.appendChild(d)), i = n(u, e), l ? u.parentNode.removeChild(u) : (d.parentNode.removeChild(d), f.style.overflow = s), !!i
        },
        j = function() {
            var e = {
                select: "input",
            ...
            return function(r, a) {
                ...
                var i = (r = "on" + r) in a;
                return i || (a.setAttribute || (a = t.createElement("div")), a.setAttribute && a.removeAttribute && (a.setAttribute(r, ""), i = o(a[r], "function"), o(a[r], "undefined") || (a[r] = n), a.removeAttribute(r))), a = null, i
            }
        }(),
        $ = {}.hasOwnProperty;
    for (var D in l = o($, "undefined") || o($.call, "undefined") ? function(e, t) {
            ...
            var n;
            return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : P(["@media (", b.join("touch-enabled),("), m, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), (function(e) {
                n = 9 === e.offsetTop
            })), n
            ...
            var e = !!s("perspective");
            return e && "webkitPerspective" in f.style && P("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", (function(t) {
            ...
            var e;
            return P(["#", m, "{font:0/0 a}#", m, ':after{content:"', v, '";visibility:hidden;font:3px/1 a}'].join(""), (function(t) {
                e = t.offsetHeight >= 3
            })), e
        }, C.video = function() {
        ...
        }, C) l(C, D) && (u = D.toLowerCase(), d[u] = C[D](), N.push((d[u] ? "" : "no-") + u));
    return d.input || (d.input = function(n) {
            for (var r = 0, o = n.length; o > r; r++) T[n[r]] = !!(n[r] in g);
        ...
        function(e, t) {
            ...
            function r(e) {
                var t = p[e[f]];
                return t || (t = {}, m++, e[f] = m, p[m] = t), t
            }

            function o(e, n, o) {
                return n || (n = t), s ? n.createElement(e) : (o || (o = r(n)), !(a = o.cache[e] ? o.cache[e].cloneNode() : d.test(e) ? (o.cache[e] = o.createElem(e)).cloneNode() : o.createElem(e)).canHaveChildren || l.test(e) || a.tagUrn ? a : o.frag.appendChild(a));
                var a
            }
            ...
            function i(e) {
                e || (e = t);
                var n = r(e);
                return !h.shivCSS || c || n.hasCSS || (n.hasCSS = !! function(e, t) {
                    var n = e.createElement("p"),
                        r = e.getElementsByTagName("head")[0] || e.documentElement;
                    return n.innerHTML = "x<style>" + t + "</style>", r.insertBefore(n.lastChild, r.firstChild)
                }(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), s || a(e, n), e
            }
            var c, s, u = e.html5 || {},
            ...
            ! function() {
                try {
                    ...
                    e.innerHTML = "<xyz></xyz>", c = "hidden" in e, s = 1 == e.childNodes.length || function() {
                        t.createElement("a");
            ...
            var h = {
                ...
                createDocumentFragment: function(e, o) {
                    ...
                    for (var a = (o = o || r(e)).frag.cloneNode(), i = 0, c = n(), u = c.length; u > i; i++) a.createElement(c[i]);
                    return a
                }
            };
            e.html5 = h, i(t)
        }(this, t), d._version = "2.8.3", d._prefixes = b, d._domPrefixes = w, d._cssomPrefixes = x, d.mq = function(t) {
            var n, r = e.matchMedia || e.msMatchMedia;
            return r ? r(t) && r(t).matches || !1 : (P("@media " + t + " { #" + m + " { position: absolute; } }", (function(t) {
                n = "absolute" == (e.getComputedStyle ? getComputedStyle(t, null) : t.currentStyle).position
            })), n)
        }, d.hasEvent = j, d.testProp = function(e) {
            return i([e])
        }, d.testAllProps = s, d.testStyles = P, d.prefixed = function(e, t, n) {
            return t ? s(e, t, n) : s(e, "pfx")
        }, f.className = f.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + N.join(" "), d
}(this, this.document);